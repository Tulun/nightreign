...
export const RELIC_VALUES: Record<string, string> = {
  ...
  "Improved Magic Damage Negation": "+10% magic negation",
  "Improved Fire Damage Negation": "+10% fire negation",
  "Improved Lightning Damage Negation": "+10% lightning negation",
  "Improved Holy Damage Negation": "+10% holy negation",
  ...
  "Attack power up when facing poison-afflicted enemy": "+10% vs poison-afflicted enemies",
  "Attack power up when facing scarlet rot-afflicted enemy": "+10% vs rot-afflicted enemies",
  "Attack power up when facing frostbite-afflicted enemy": "+10% vs frostbite-afflicted enemies",
  "Night of the Beast: Recover Stamina on Attack": "+3 stamina per hit (Night of the Beast exclusive)",
  "Stamina Recovery upon Landing Attacks": "+2 stamina per hit",
