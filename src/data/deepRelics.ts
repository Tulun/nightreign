...
export const deepRelics: DeepRelic[] = [
  ...
  { name: "Physical attack power increases after using grease items +1/2", effect: "Increases physical damage by 1.17x / 1.2x for 30s after using a grease item", category: "offensive", stack: "tiers" },
  { name: "Attack power up when facing poison/scarlet rot/frostbite-afflicted enemy +1/2", effect: "Increases damage by 1.16x / 1.2x against enemies suffering the specified status", category: "offensive", stack: "tiers" },
  ...
  { name: "Art gauge fills moderately upon critical hit +1", effect: "+6.5 character-skill gauge on a riposte", category: "offensive", stack: "tiers", note: "Sentence case to match its own base tier — the sheet title-cased only this one of the three Art-gauge lines." },
  ...
  { name: "Physical attack power increases after using grease items +0", effect: "+10% physical damage for 30s after using a grease item", category: "offensive", stack: "tiers", crossover: true },
  { name: "Attack power up when facing frostbite/poison/scarlet rot-afflicted enemy +0", effect: "+10% damage against enemies suffering the specified status", category: "offensive", stack: "tiers", crossover: true },
  ...
  { name: "Guard counter is given a boost based on current HP", effect: "Adds a flat hit (≈ current HP ÷ 20) to each guard counter", category: "offensive", stack: "no", crossover: true },
