...
export const greatHollowMaps: HollowMap[] = [
  ...
  },
  {
    ...
    image: "/maps/great-hollow-underground.png",
    width: 1080,
    height: 1080,
    crystals: [
      { id: "u1", sets: ["C"], x: 62, y: 16 },
      { id: "u2", sets: ["B"], x: 50, y: 47 },
      { id: "u3", sets: ["A", "D"], x: 80, y: 49 },
      { id: "u4", sets: ["A", "B"], x: 30, y: 64 },
      { id: "u5", sets: ["C", "D"], x: 37, y: 86 },
      { id: "u6", sets: ["C", "D"], x: 70, y: 86 },
    ],
  },
];
